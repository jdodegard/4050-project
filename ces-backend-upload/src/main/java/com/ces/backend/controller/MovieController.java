package com.ces.backend.controller;

import com.ces.backend.model.Movie;
import com.ces.backend.model.MovieStatus;
import com.ces.backend.service.MovieService;
 ...
 * CORS is open so the frontend dev server can reach the API during Sprint 1.
 */
@RestController
